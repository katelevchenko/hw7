...
var _lighter = __webpack_require__(348);

var _bulb = __webpack_require__(350);

var _garland = __webpack_require__(352);
...
var Bulb = exports.Bulb = function () {
    function Bulb(targetEl) {
        ...
        this.isEnabled = false; //состояние, чтобы оперировать
        console.log(this);
        this.control.addEventListener('click', this.toggle.bind(this)); //() => this.toggle());
    }
...
var Garland = exports.Garland = function () {
    ...
    _createClass(Garland, [{
        ...
        value: function toggleAll() {
            var enabled = this.bulbs.filter(function (bulb) {
